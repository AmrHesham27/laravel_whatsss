...
<head>
    ...
    <!--====== Default css ======-->
    <link rel="stylesheet" href="home/css/custom-animation.css">
    <link rel="stylesheet" href="home/css/default.css">
    
    <!--====== Style css ======-->
    <link rel="stylesheet" href="home/css/rtl.css">
...
<body>    
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4  col-md-7 col-sm-6 col-6 order-2 order-sm-3">
                        <div class="appie-btn-box text-left">
                            ...
                            <a class="main-btn mr-30" href="#">Get Started</a>
    ...
    <section class="appie-hero-area">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="appie-hero-content text-right">
                        <span>Welcome To Appie</span>
                        <h1 class="appie-title">Manage it all, in this all new system.</h1>
        ...
        <div class="hero-shape-1">
            <img src="home/images/shape/shape-2.png" alt="">
        </div>
        <div class="hero-shape-2">
            <img src="home/images/shape/shape-3.png" alt="">
        </div>
        <div class="hero-shape-3">
            <img src="home/images/shape/shape-4.png" alt="">
        </div>
    </section>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="appie-section-title text-center">
                        <h3 class="appie-title">Designed with <br> The applicant in mind.</h3>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="appie-single-service text-center mt-30 item-2 wow animated fadeInUp" data-wow-duration="2000ms" data-wow-delay="400ms">
                        ...
                        <h4 class="appie-title">Designing</h4>
                        <p>Mucker plastered bugger all mate morish are.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="appie-single-service text-center mt-30 item-4 wow animated fadeInUp" data-wow-duration="2000ms" data-wow-delay="800ms">
                        ...
                        <h4 class="appie-title">Suporting</h4>
                        <p>Mucker plastered bugger all mate morish are.</p>
                    </div>
                </div>
            </div>
    ...
    <section class="appie-features-area pt-100" id="features">
            ...
            <div class="row align-items-center">
                <div class="col-lg-3">
                    <div class="appie-features-tabs-btn">
                        <div class="nav flex-column nav-pills text-right" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-6">
                                    <div class="appie-features-thumb text-center wow animated fadeInUp" data-wow-duration="2000ms" data-wow-delay="200ms">
                                        <img src="home/images/features-thumb-1.png" alt="">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="appie-features-content text-right wow animated fadeInRight" data-wow-duration="2000ms" data-wow-delay="600ms">
        ...
        <div class="features-shape-1">
            <img src="home/images/shape/shape-6.png" alt="">
        </div>
        <div class="features-shape-2">
            <img src="home/images/shape/shape-7.png" alt="">
        </div>
        <div class="features-shape-3">
            <img src="home/images/shape/shape-8.png" alt="">
        </div>
    </section>
    ...
    <section class="appie-traffic-area appie-traffic-area-rtl  pt-140 pb-180">
        <div class="container">
            <div class="row">
                <div class="col-lg-7">
                    <div class="appie-traffic-title text-right">
                        <span>Traffic</span>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="appie-traffic-service mb-30 text-right">
                                <div class="icon">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="appie-traffic-service item-2 mb-30 text-right">
                                <div class="icon">
                                    <i class="fal fa-check"></i>
                                </div>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="appie-traffic-service item-3 text-right">
                                <div class="icon">
                                    <i class="fal fa-check"></i>
                                </div>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="appie-traffic-service item-4 text-right">
                                <div class="icon">
                                    <i class="fal fa-check"></i>
                                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="traffic-btn mt-50 text-right">
        ...
        <div class="traffic-thumb ">
            <img class="wow animated fadeInRight" data-wow-duration="2000ms" data-wow-delay="200ms" src="home/images/traffic-thumb.png" alt="">
        </div>
    </section>
    ...
    <section class="appie-testimonial-area pt-100 pb-160" id="testimonial">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="appie-testimonial-slider-rtl">
                        <div class="appie-testimonial-item text-center">
                            <div class="author-info">
                                <img src="home/images/testimonial-user.png" alt="">
                ...
                <div id="month">
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-6 wow animated fadeInLeft">
                            <div class="pricing-one__single text-right">
                        ...
                        <div class="col-lg-4 col-md-6 wow animated fadeInUp">
                            <div class="pricing-one__single center text-right">
                                <div class="pricig-heading">
                                    <h6>Sweet</h6>
    ...
    <section class="appie-faq-area appie-faq-area-rtl pb-95">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="appie-section-title text-center">
                    ...
                    <div class="faq-accordion wow fadeInRight mt-30" data-wow-duration="1500ms">
                        <div class="accrodion-grp wow fadeIn" data-wow-duration="1500ms" data-grp-name="faq-accrodion">
                            <div class="accrodion active ">
                                <div class="accrodion-inner text-right">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="appie-blog-item mt-30 wow animated fadeInUp text-right" data-wow-duration="3000ms" data-wow-delay="200ms">
                        <div class="thumb">
                            <img src="home/images/blog-1.jpg" alt="">
                        </div>
                        <div class="content">
                            <div class="blog-meta">
                                <ul>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="appie-blog-item mt-30 wow animated fadeInUp text-right" data-wow-duration="3000ms" data-wow-delay="400ms">
                        <div class="thumb">
                            <img src="home/images/blog-2.jpg" alt="">
                        </div>
                        <div class="content">
                            <div class="blog-meta">
                                <ul>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="appie-blog-item mt-30 wow animated fadeInUp text-right" data-wow-duration="3000ms" data-wow-delay="600ms">
                        <div class="thumb">
                            <img src="home/images/blog-3.jpg" alt="">
                        </div>
                        <div class="content">
                            <div class="blog-meta">
                                <ul>
    ...
    <section class="appie-project-area appie-project-area-rtl pb-100">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="appie-project-box wow animated slideInUp" data-wow-duration="1000ms" data-wow-delay="0ms">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="appie-project-content text-right">
                                    <h3 class="title">Start your project with appie.</h3>
                        ...
                        <div class="appie-project-thumb">
                            <img src="home/images/project-thumb.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="appie-footer-area">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="footer-about-widget text-right">
                        <div class="logo">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-widget-info text-right">
